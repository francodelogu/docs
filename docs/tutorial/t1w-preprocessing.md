Draft 1 - LTU Behavioral Neuroscience team at LTU - Spring 2022 

# INTRODUCTION on Anatomical (T1w) preprocessing.

This page demonstrate common steps used to preprocess anatomical magnetic resonance imaging data (T1-weighted or T1w) on brainlife.io The goal of this tutorial is to show how process anatomical data for successive analyses – volumetric analyses from T1w measures, combination of T1w and diffusion-weighted MRI (dMRI) or functional neuroimaging data (fMRI) pipelines.
...
### C) Freesurfer Brain Parcellation - Generation.
...
### 1. Copy appropriate data over from a single subject in the HCP 3T Diffusion project

1. Click the following link to go to the project's page for the [HCP 3T Diffusion project](https://brainlife.io/project/5941a225f876b000210c11e5){target=_blank}
...
### 2. Crop and reorient anatomical (T1w) image.
...
### 3. ACPC-align anatomical (T1w) image.
...
### 4. Freesurfer Brain Parcellation - Generation.
...
### 5. Freesurfer Brain Parcellation - Statistics.
